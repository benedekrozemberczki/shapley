...
------------------------------
The Shapley values are returned as a Numpy float array which has 2 dimensions - rows represent the games and columns are players. A given value in the array is the Shapley value of a player in a game. 
